<form class="container pt-4 mt-2" method="post" action="Signup/signup">
...
<hr>
<br>
<div class="text text-center">Join us as an Agency: <a href="<?php echo site_url('signup/signup_agency'); ?>">
  Sign Up !
</a></div>
